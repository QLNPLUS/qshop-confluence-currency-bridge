...
public class QShopConfluenceMod {
    ...
    public QShopConfluenceMod() {
        IEventBus modBus = FMLJavaModLoadingContext.get().getModEventBus();
        modBus.addListener(BridgeEvents::onConfigLoading);
        modBus.addListener(BridgeEvents::onConfigReloading);
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, BridgeConfig.SPEC,
                "qshop-confluence-common.toml");
        MinecraftForge.EVENT_BUS.register(BridgeEvents.class);
        logStartupState();
    }
